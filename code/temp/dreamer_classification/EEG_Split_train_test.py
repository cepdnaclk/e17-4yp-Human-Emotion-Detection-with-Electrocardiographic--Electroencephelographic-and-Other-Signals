...
output_directory = 'Train_Test_Split_EEG'
if not os.path.exists(output_directory):
    os.makedirs(output_directory)
# Define the input files and the output files
data_file1 = "./EEG/EEG_a.txt"
data_file2 = "./EEG/EEG_b.txt"
data_file3 = "./EEG/EEG_c.txt"
data_file4 = "./EEG/EEG_d.txt"
data_file5 = "./EEG/EEG_e.txt"
data_file6 = "./EEG/EEG_f.txt"
data_file7 = "./EEG/EEG_g.txt"
data_file8 = "./EEG/EEG_h.txt"
data_file9 = "./EEG/EEG_i.txt"
data_file10 = "./EEG/EEG_j.txt"
data_file11 = "./EEG/EEG_k.txt"
data_file12 = "./EEG/EEG_l.txt"
data_file13 = "./EEG/EEG_m.txt"
data_file14 = "./EEG/EEG_n.txt"

labels_file = "./Labels/labels.txt"

train_data_file1 = "./Train_Test_Split_EEG/train_a.txt"
train_data_file2 = "./Train_Test_Split_EEG/train_b.txt"
train_data_file3 = "./Train_Test_Split_EEG/train_c.txt"
train_data_file4 = "./Train_Test_Split_EEG/train_d.txt"
train_data_file5 = "./Train_Test_Split_EEG/train_e.txt"
train_data_file6 = "./Train_Test_Split_EEG/train_f.txt"
train_data_file7 = "./Train_Test_Split_EEG/train_g.txt"
train_data_file8 = "./Train_Test_Split_EEG/train_h.txt"
train_data_file9 = "./Train_Test_Split_EEG/train_i.txt"
train_data_file10 = "./Train_Test_Split_EEG/train_j.txt"
train_data_file11 = "./Train_Test_Split_EEG/train_k.txt"
train_data_file12 = "./Train_Test_Split_EEG/train_l.txt"
train_data_file13 = "./Train_Test_Split_EEG/train_m.txt"
train_data_file14 = "./Train_Test_Split_EEG/train_n.txt"

train_labels_file = "./Train_Test_Split_EEG/train_labels.txt"

test_data_file1 = "./Train_Test_Split_EEG/test_a.txt"
test_data_file2 = "./Train_Test_Split_EEG/test_b.txt"
test_data_file3 = "./Train_Test_Split_EEG/test_c.txt"
test_data_file4 = "./Train_Test_Split_EEG/test_d.txt"
test_data_file5 = "./Train_Test_Split_EEG/test_e.txt"
test_data_file6 = "./Train_Test_Split_EEG/test_f.txt"
test_data_file7 = "./Train_Test_Split_EEG/test_g.txt"
test_data_file8 = "./Train_Test_Split_EEG/test_h.txt"
test_data_file9 = "./Train_Test_Split_EEG/test_i.txt"
test_data_file10 = "./Train_Test_Split_EEG/test_j.txt"
test_data_file11 = "./Train_Test_Split_EEG/test_k.txt"
test_data_file12 = "./Train_Test_Split_EEG/test_l.txt"
test_data_file13 = "./Train_Test_Split_EEG/test_m.txt"
test_data_file14 = "./Train_Test_Split_EEG/test_n.txt"

test_labels_file = "./Train_Test_Split_EEG/test_labels.txt"
